...
<body>
    ...
    <div class="row d-flex justify-content-center contenedorPrincipal">
        ...
        <div class="col-12 col-md-3 mt-4 mb-4 ps-md-5 pe-0 infoCompra">
            ...
            <button type="button" class="botonEnviarModal" data-bs-toggle="modal" data-bs-target="#exampleModal">CONFIRMAR Y PAGAR PEDIDO</button>
            ...
            <div class="modal-dialog modal-dialog-centered">
                ...
                <div class="bodyModal modal-body d-flex justify-content-center align-items-center flex-column">
                    <img src="img/qrPrueba.jpg" alt="">
                    <h4>Gracias por su compra!</h4>
                    <h5>Escanee el código para ver su pedido.</h5>
                </div>
                <div class="modal-footer">
                    <button id="cerrar" type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                    <button type="button" class="btn btn-primary">Déjanos tu opinión</button>
                </div>
                </div>
            </div>
            </div>
    ...
    <script src="src/modalCarrito.js"></script>
</body>
</html>