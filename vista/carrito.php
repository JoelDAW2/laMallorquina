...
<body>
    ...
    <div class="row d-flex justify-content-center contenedorPrincipal">
        ...
        <div class="col-12 col-md-3 mt-4 mb-4 ps-md-5 pe-0 infoCompra">
            ...
            <button id="botonModal" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-footer">
                    <button id="cerrar" type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
